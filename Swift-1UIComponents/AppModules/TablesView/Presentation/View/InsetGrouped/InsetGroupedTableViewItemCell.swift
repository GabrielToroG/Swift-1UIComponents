//
//  InsetGroupedTableViewItemCell.swift
//  Swift-1UIComponents
//
...
struct UiInsetGroupedTableOption {
    let title: String
}

class InsetGroupedTableViewItemCell: UITableViewCell {
    ...
    // Properties
    var item: UiInsetGroupedTableOption? {
        didSet {
...
// MARK: - UI Functions
private extension InsetGroupedTableViewItemCell {
