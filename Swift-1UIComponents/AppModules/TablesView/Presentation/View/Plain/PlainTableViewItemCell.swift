...
struct UiPlainTableOption {
    let title: String
}

class PlainTableViewItemCell: UITableViewCell {
...
// MARK: - UI Functions
private extension PlainTableViewItemCell {
